...
public class ImportDutyICriteriaItegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    ICriteria = new ImportDutyCriteria(repo);
  }
  ...
  public void testSatisfy() throws Exception {
    ...
    assertTrue(satisfiedItems.contains(new BillItem("SKU22", 1, BigDecimal.TEN)));

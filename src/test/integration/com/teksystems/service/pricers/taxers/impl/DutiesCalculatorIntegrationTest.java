...
public class DutiesCalculatorIntegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    criteria = new ImportDutyCriteria(repo);
  ...
  public void testHandleAllSkus() throws Exception {
    ...
    assertEquals(BigDecimal.valueOf(2.00).setScale(2), taxes.get(TaxType.DUTIES));
  ...
  public void testHandleOnlyExceptedSkus() throws Exception {
    ...
    Map<TaxType, BigDecimal> taxes = new HashMap<TaxType, BigDecimal>();
    taxCalculator.handle(items, taxes);
    assertEquals(BigDecimal.valueOf(0.00).setScale(2), taxes.get(TaxType.DUTIES));

  }

  @Test
  public void testHandleOnlyNotImportedSkus() throws Exception {
    List<BillItem> items = Arrays.asList(
        new BillItem[]{
            new BillItem("SKU01", 1, BigDecimal.TEN),
            new BillItem("SKU21", 1, BigDecimal.TEN),

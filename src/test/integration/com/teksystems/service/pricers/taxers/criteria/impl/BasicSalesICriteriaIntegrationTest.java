...
public class BasicSalesICriteriaIntegrationTest {
  ...
  public void testSatisfy() throws Exception {
    ...
    assertEquals(8, satisfiedItems.size());
    assertTrue(satisfiedItems.contains(new BillItem("SKU01", 1, BigDecimal.TEN)));
    assertTrue(satisfiedItems.contains(new BillItem("SKU02", 1, BigDecimal.TEN)));
    ...
    assertTrue(satisfiedItems.contains(new BillItem("SKU41", 1, BigDecimal.TEN)));
    assertTrue(satisfiedItems.contains(new BillItem("SKU42", 1, BigDecimal.TEN)));
  }

...
public class StateTaxCalculatorTest {
  ...
  private StateTaxCalculator taxCalculator;
  @Mock
  ...
  public void setUp() throws Exception {
    ...
    taxCalculator = new StateTaxCalculator(criteria);
  ...
  public void testHandle() throws Exception {
    ...
    assertEquals(BigDecimal.valueOf(0.70).setScale(2), taxes.get(TaxType.STATE));
  ...
  public void testProcessItem() throws Exception {
    assertEquals(BigDecimal.valueOf(0.70).setScale(2), taxCalculator.processItem(items.get(0)));
  }

  @Test
  public void testGetTaxCalculatorType() throws Exception {

    assertEquals(TaxType.STATE, taxCalculator.getTaxCalculatorType());
  }
